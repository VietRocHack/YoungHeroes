...
// The pre-Live-API implementation, kept behind a toggle in PracticeCall.jsx
// until the Live flow (PracticeCallLive.jsx) has had real-device voice
// testing — see docs/adr/0005-live-api-for-voice-call.md.
export default function PracticeCallClassic() {
